...
def main():
    ...
    query = {
            "match":
                {"text":
                    "diabetes, blood glucose, mellitus, heart attack, coronary attack, cardiac infarction, myocardial infarction, heart infarction, myocardial infarct, myocardial necrosis, cardiac arrest, asystolic, asystole, heart arrest, ventricular fibrillation, pulseless electrical activity, heart failure, cardiac failure, hypertension, high blood pressure"
                    }
            }
    #Name of your output file: Please change
    #pattern : yourname_Query_<number> --> Neel_Query_1
    output_filename = "Mannila_Query_1"
...
if __name__=="__main__":
    main()
    print("Done!!! --> Check your file at /home/nshah5/Mannila_Query_1.json")